...
const Proc = {
  ...
  addConfirmation(b, ctx) {
    ...
    for (const l of lines) {
      if (l.received_qty > 0) {
        Stock.receiveLot({ item_id: l.item_id, item_name: l.item_name, unit: l.unit, qty: l.received_qty, cost: l.price, warehouse_id: wh.id, warehouse_name: wh.name, expiry, qc: qc.result, order_num: o.num, date: arrival });
