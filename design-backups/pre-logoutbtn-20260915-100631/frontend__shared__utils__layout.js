...
(function () {
  ...
  window.Layout = {
    ...
    kpi(c) {
      ...
      return '<div class="kpi-card"' + linkAttr + nameAttr + cursorStyle + '><div class="kpi-ico">' + (c.icon || '•') + '</div>'
  ...
  function ensureNotifBell() {
    ...
    // مسار مطلق أولاً (يعمل من أي عمق: /قسم/ أو /قسم/index.html)، ثم النسبي كاحتياط
    var s = document.createElement('script');
    s.src = '/shared/utils/notifications.js?v=2';
    ...
    s.onerror = function () {
      try {
        ...
        f.src = base + 'shared/utils/notifications.js?v=2';
  ...
  function ensureUserSwitch() {
    ...
    var s = document.createElement('script');
    s.src = '/shared/utils/user-switch.js?v=1';
    ...
    s.onerror = function () {
      try {
        ...
        var f = document.createElement('script');
        f.src = base + 'shared/utils/user-switch.js?v=1';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ensureHead(); upgradeSidebar(); injectTopbar(); injectFooter(); loadConfig(); ensureNotifBell(); ensureUserSwitch();
  });
})();
